...
class UiSize {
  ...
  static const double bottomSheetTopIconWidth = 42; // todo rename
  static const double bottomSheetTopIconHeight = 15; // todo rename
}
...
class AppDefaults {
  ...
  static const BorderRadius allBorderRadius = BorderRadius.all(Radius.circular(radius));
